...
export class UserCRUD {
    ...
    loadTableContent(user) {
        ...
        tr.innerHTML = `<td id = "fname">${user.firstName}</td>
                        ...
                        <td id = "createDate">${user.created_on}</td>
                        <td id = "modDate">${user.modified_on}</td>
                        `;
        tr.append(editBtn);
        tr.append(deleteBtn);
    ...
    addUser() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let cols in this.col) {
                ...
                if (this.col[cols] == "created_on" || this.col[cols] == "modified_on") {
    ...
    update(user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let createDateCell = tr.cells.namedItem("createDate");
            let modDateCell = tr.cells.namedItem("modDate");
            if (editbtn.innerHTML === "Edit") {
                ...
                createDateCell.contentEditable = "false";
                modDateCell.contentEditable = "false";
                const customerList = yield getCustomerList(this.myURL);
    ...
    save(user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let modified_onCell = tr.cells.namedItem("modDate");
